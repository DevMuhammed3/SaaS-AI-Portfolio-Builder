export default {
  ...
  // SEO
  "seo.home.title": "10minportfolio – Free Portfolio Builder for Developers",
  "seo.home.description":
    "Design your developer portfolio in minutes. No code required. 100% responsive and SEO-friendly. Try it free.",
  "seo.features.title": "Features - 10minportfolio",
  "seo.features.description":
    "Discover all the powerful features that make our portfolio builder the best choice for professionals.",
  "seo.pricing.title": "Pricing - 10minportfolio",
  "seo.pricing.description":
    "Choose the perfect plan for your portfolio needs. Start building professional portfolios today.",
  "seo.publicportfolios.title": "Developers portfolios - 10minportfolio",
  "seo.publicportfolios.description":
    "Browse through our collection of public portfolios and get inspired by amazing work from professionals worldwide.",
  ...
  "dashboard.premiumAccess": "Unlock access",

  "story.heading": "Why I built 10minPortfolio",
  "story.reason1":
  ...
  "story.watchFull": "Watch the Full Story",
  "seo.dashboard.title": "Dashboard - 10minportfolio",
  "seo.dashboard.description":
    "Manage your portfolios, track analytics, and access premium features all in one place.",
  "seo.checkout.title": "Checkout - 10minportfolio",
  "seo.checkout.description":
    "Complete your purchase and unlock premium features to enhance your portfolio.",
} as const;
